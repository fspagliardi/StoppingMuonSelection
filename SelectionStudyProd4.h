...
class SelectionStudyProd4 : public art::EDAnalyzer {
public:
  explicit SelectionStudyProd4(fhicl::ParameterSet const & p);
  // The destructor generated by the compiler is fine for classes
  // without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  SelectionStudyProd4(SelectionStudyProd4 const &) = delete;
  SelectionStudyProd4(SelectionStudyProd4 &&) = delete;
  SelectionStudyProd4 & operator = (SelectionStudyProd4 const &) = delete;
  SelectionStudyProd4 & operator = (SelectionStudyProd4 &&) = delete;
...
SelectionStudyProd4::SelectionStudyProd4(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p)
{
  reconfigure(p);
...
void SelectionStudyProd4::beginJob()
{
...
void SelectionStudyProd4::endJob()
{
  mf::LogVerbatim("SelectionStudyProd4") << "SelectionStudyProd4 finished job";
...
void SelectionStudyProd4::respondToOpenInputFile(art::FileBlock const &inputFile) {
  filename = inputFile.fileName();
  std::cout << "Analyzer on file: " << filename << std::endl;
}

void SelectionStudyProd4::reconfigure(fhicl::ParameterSet const& p)
{
...
void SelectionStudyProd4::UpdateTTreeVariableWithTrackProperties(const trackProperties &trackInfo) {
