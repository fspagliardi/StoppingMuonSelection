...
namespace stoppingcosmicmuonselection {
  ...
  void StoppingMuonSelectionAlg::CorrectPosEnd(TVector3 &_recoStartPoint, TVector3 &_recoEndPoint, const double &minHitPeakTime, const double &maxHitPeakTime) {
    ...
    _recoEndPoint.SetX(sign*(drift_distance-drift_time_end_point * drift_velocity));
  ...
  bool StoppingMuonSelectionAlg::IsTrueParticleAnAnodeCrossingStoppingMuon(art::Event const &evt, recob::PFParticle const &thisParticle) {
    ...
    double *av = geoHelper.GetActiveVolumeBounds();
    bool goodYZ_Pos = (Y_anode_PosX>av[2] && Y_anode_PosX<av[3] && Z_anode_PosX>av[4] && Z_anode_PosX<av[5]) && (_trueStartPoint.X()>_trueEndPoint.X());
    bool goodYZ_Neg = (Y_anode_NegX>av[2] && Y_anode_NegX<av[3] && Z_anode_NegX>av[4] && Z_anode_NegX<av[5]) && (_trueStartPoint.X()<_trueEndPoint.X());
